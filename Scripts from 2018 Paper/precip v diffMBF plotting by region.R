...
colnames(ROnew) <- c("site_name","climate_div_name","WY","MinRO")
...
plot(meansALL$P,meansALL$MinRO, col = cols[meansALL$Region], ylab = "% Difference from Mean Baseflow", xlab = "Annual Precip (mm)", ylim = c(-80,170))
