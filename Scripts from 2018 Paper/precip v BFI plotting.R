...
###
###
###Didn't change "min" variable names below bc they are just names but this plots AVG RO
library(reshape2)
MinRO <- read.csv("avg_RO_lowdev_96-16.csv")
 # [1] "X.1"              "ID"               "WY96"             "WY97"            
...
########
plot(PROmin$P, PROmin$MinRO, col = PROmin$Climate_Div, ylab = "Mean Yearly Runoff (mm/d)", xlab = "Precip in Climate Division (mm)")
